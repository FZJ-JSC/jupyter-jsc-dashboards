...
# ### TODO
# - Hinweis auf Kartenmaterial, Dash, Plotly in Footer
# - check if cache survives restart. If, yes then delete cache first
# 
# ### before publish
# - set correct asset_url
# - set cache_time=86400
# - uncomment app.config.suppress_callback_exception
...
cache_timeout=86400  # on day in secounds
...
metadata = pd.read_csv("/app/assets/metadata.csv")
